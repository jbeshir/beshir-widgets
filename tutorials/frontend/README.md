...
| 04 | pennsic-planner | External observable store + remote persistence with optimistic concurrency, capability-URL hash routing, JS layout geometry, and client-side ICS generation | [04-pennsic-planner.md](./04-pennsic-planner.md) |
